...
export const EnergyConsumptionColumn = ({
  style,
  series,
  categories,
  leftYLabel,
  ...
  if (series.length > 0) {
    series.forEach((element: any) => {
      element.type = 'column';
      if (element.name == 'ELECTRICITY') {
        element.pointPadding = 0.2;
        element.pointPlacement = -0.2;
      }
      if (element.name == 'ELECTRICITY INTENSITY') {
        element.pointPadding = 0.5;
        element.pointPlacement = -0.2;
      }
      if (element.name == 'COOLING') {
        element.pointPadding = 0;
        element.pointPlacement = -0.2;
      }
      if (element.name == 'COOLING INTENSITY') {
        element.pointPadding = 0.5;
        element.pointPlacement = -0.2;
      }
      if (element.name == 'INTENSITY') {
        element.pointPadding = 0.4;
        element.pointPlacement = -0.2;
      }
